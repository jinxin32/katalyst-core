...
func TestCPUProvisionOptions_ApplyTo_RegionIndicatorTimeTarget(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			timeTargetOptions: map[string]string{
				"share": `{"cpu_sched_wait":[{"timeRange":["09:00","18:00"],"target":400}]}`,
			},
			wantErr:         false,
		...
		},
		{
			...
			timeTargetOptions: map[string]string{
				"share": `{"cpu_sched_wait":[{"timeRange":["09:00","18:00"],"target":400}],"cpu_usage_ratio":[{"timeRange":["09:00","18:00"],"target":0.9}]}`,
			},
			wantErr:         false,
			wantRegionTypes: []v1alpha1.QoSRegionType{v1alpha1.QoSRegionTypeShare},
			wantIndicatorNames: map[v1alpha1.QoSRegionType][]string{
		...
		},
		{
			...
			timeTargetOptions: map[string]string{
				"share":     `{"cpu_sched_wait":[{"timeRange":["09:00","18:00"],"target":400}]}`,
				"dedicated": `{"cpi":[{"timeRange":["09:00","18:00"],"target":1.2}]}`,
			},
			wantErr:         false,
		...
		},
		{
			...
			timeTargetOptions: map[string]string{
				"share": `{"cpu_sched_wait":[{"timeRange":["09:00","18:00"],"target":400},{"timeRange":["18:00","22:00"],"target":300}]}`,
			},
			wantErr:         false,
			wantRegionTypes: []v1alpha1.QoSRegionType{v1alpha1.QoSRegionTypeShare},
			wantIndicatorNames: map[v1alpha1.QoSRegionType][]string{
...
func TestCPUProvisionOptions_ApplyTo_RegionIndicatorTimeTarget_ParsesSlotValues(t *testing.T) {
	...
	options.RegionIndicatorTimeTargetOptions = map[string]string{
		"share": `{"cpu_sched_wait":[{"timeRange":["09:00","18:00"],"target":400},{"timeRange":["18:00","22:00"],"target":300}],"cpu_usage_ratio":[{"timeRange":["09:00","18:00"],"target":0.9}]}`,
	}
	...
	if !equalHHMMTimeSlices(schedWaitSlots[0].TimeRange, []v1alpha1.HHMMTime{"09:00", "18:00"}) {
		t.Errorf("expected timeRange [09:00, 18:00] for first slot, got %v", schedWaitSlots[0].TimeRange)
	}
	...
	if !equalHHMMTimeSlices(schedWaitSlots[1].TimeRange, []v1alpha1.HHMMTime{"18:00", "22:00"}) {
		t.Errorf("expected timeRange [18:00, 22:00] for second slot, got %v", schedWaitSlots[1].TimeRange)
	}
